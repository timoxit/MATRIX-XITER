...
function BotTerminal({ onAdminLogin }) {
  const [logs, setLogs] = useState([
    { type: 'system', text: 'MATRIX XITER BOT OS v1.0.0 Booting...' },
    { type: 'system', text: 'Initializing Gateway connection...' },
    { type: 'success', text: '[OK] Connected to Discord API Gateway' },
    { type: 'success', text: '[OK] Logged in as MATRIX XITER#1507' },
  ...
  return (
    <div className="glass-panel" style={{
      ...
      <div style={{
        ...
        <span style={{ color: 'var(--text-secondary)', fontSize: '0.75rem', fontWeight: '600' }}>matrix_xiter@bot-status: ~</span>
