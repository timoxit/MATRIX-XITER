...
export const setToken = (token) => {
  if (token) {
    localStorage.setItem('matrix_xiter_token', token);
  } else {
    localStorage.removeItem('matrix_xiter_token');
    localStorage.removeItem('timoxiter_token');
  }
};

export const getToken = () => {
  return localStorage.getItem('matrix_xiter_token') || localStorage.getItem('timoxiter_token');
};

export const setUser = (user) => {
  if (user) {
    localStorage.setItem('matrix_xiter_user', JSON.stringify(user));
  } else {
    localStorage.removeItem('matrix_xiter_user');
...
export const getUser = () => {
  try {
    const userStr = localStorage.getItem('matrix_xiter_user') || localStorage.getItem('timoxiter_user');
